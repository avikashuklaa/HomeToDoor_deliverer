...
class _SignupScreenState extends State<SignupScreen> {
    ...
    if (imageXFile==null){
      ...
      if(confirmPasswordController.text == passwordController.text){
        ...
        if(confirmPasswordController.text.isNotEmpty && emailController.text.isNotEmpty && phoneController.text.isNotEmpty && locationController.text.isNotEmpty && nameController.text.isNotEmpty ){
          ...
          fStorage.Reference reference = fStorage.FirebaseStorage.instance.ref().child("deliverers").child(fileName);
  ...
  Future saveDataToFirestore(User currentUser) async{
    FirebaseFirestore.instance.collection("deliverers").doc(currentUser.uid).set({
      "delivererUid": currentUser.uid,
      "delivererEmail": currentUser.email,
      "delivererName": nameController.text.trim(),
      "delivererAvatarUrl": chefImageURL,
      "delivererPhone": phoneController.text.trim(),
